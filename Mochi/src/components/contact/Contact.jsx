...
const Contact = () => {
  const handleCall = () => {
    window.location.href = "tel:+33753777557";
  };
  return (
      ...
      {/* <div className={styles.main}>
        <div className={styles.up}>
          <button
            ...
            onClick={() =>
              (window.location.href =
                "https://www.instagram.com/mochi_france?igsh=YXk0YzM0OGh5Z2Np&utm_source=qr")
            }
          >
            <svg
          ...
          <button
            ...
            onClick={() =>
              window.open(
                "https://www.tiktok.com/@mochi_france?_t=8nMTDqs0EYD&_r=1",
                "_blank"
              )
            }
          >
        ...
        <div className={styles.down}>
          <button
            ...
            onClick={() => window.open("https://wa.me/+33753777557", "_blank")}
          >
            <svg
              width="30"
              height="30"
          ...
          <button
            ...
            onClick={() =>
              (window.location.href = "mailto:mochifrance2024@gmail.com")
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
